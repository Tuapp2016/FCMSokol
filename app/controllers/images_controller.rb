class ImagesController < ApplicationController
  ...
  private
    ...
    def sendMessageToTopicWithImage(topic,body,title,subtitle,imageUrl,imageThumbUrl)
      ...
      options = {notification: {body: body,title:title,sound:"default",subtitle:subtitle,click_action:"co.edu.unal.agutierrezt.sokol.screenshot"},data:{image_url: imageUrl,image_thumb_url: imageThumbUrl},priority:"high",content_available:true,time_to_live:2419200,collapse_key:"co.edu.unal.agutierrezt.sokol.screenshot"}
